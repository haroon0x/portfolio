...
export default function Projects() {
  ...
  const allProjects = [
    ...
    },
    {
      ...
      description: 'Innovative music discovery platform with AI-powered recommendations. Helping users find their next favorite song through intelligent curation.',
      longDescription: 'A music discovery platform that uses advanced algorithms to recommend new music based on listening habits. Features playlist creation, social sharing, and artist discovery.',
      year: '2022',
      duration: '5 months',
      tech: ['Vue.js', 'Spotify API', 'Python', 'TensorFlow'],
      status: 'Development',
    ...
    },
    {
      ...
      category: 'Education',
      description: 'Interactive learning platform with adaptive content delivery. Revolutionizing online education through personalized learning experiences.',
      longDescription: 'An adaptive learning platform that personalizes content based on student performance. Features interactive lessons, progress tracking, and instructor tools.',
      year: '2022',
      duration: '8 months',
      tech: ['React', 'Node.js', 'MongoDB', 'WebRTC', 'AI'],
      status: 'Live',
    ...
    },
    {
      ...
      category: 'Travel',
      description: 'Comprehensive travel planning application with itinerary management and local recommendations. Making travel planning effortless and enjoyable.',
      longDescription: 'A complete travel planning solution that helps users create detailed itineraries, find accommodations, and discover local experiences. Features offline maps and real-time updates.',
      year: '2021',
      duration: '6 months',
      tech: ['React', 'Google Maps API', 'Firebase', 'PWA'],
      status: 'Live',
    ...
    },
    {
      ...
      title: 'Portfolio CMS',
      category: 'Creative',
      description: 'Content management system designed specifically for creative professionals. Empowering artists and designers to showcase their work beautifully.',
      longDescription: 'A specialized CMS built for creative professionals to manage and showcase their portfolios. Features drag-and-drop editing, custom themes, and client collaboration tools.',
      year: '2021',
      duration: '4 months',
      tech: ['Next.js', 'Strapi', 'GraphQL', 'Cloudinary'],
      status: 'Live',
          ...
          >
                  ...
                  <button
                    ...
                    className={`px-6 py-3 rounded-full font-medium transition-all duration-300 ${
                      selectedCategory === category
                        ...
                        : 'bg-zinc-900 text-white/70 hover:text-white hover:bg-zinc-800 border border-white/10 hover:border-white/20'
                    }`}
                  >
                    {category}
                  </button>
            ...
            <div ref={staggerRef} className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              {filteredProjects.map((project, index) => (
                <div 
                  key={project.id}
                  className={`group bg-zinc-950 rounded-xl border border-white/10 overflow-hidden hover:border-blue-400/30 card-3d cursor-pointer ${
                ...
                >
                  ...
                  <div className="p-4 space-y-3">
                    <h3 className="text-lg font-light text-white group-hover:gradient-text transition-all duration-500">
                      {project.title}
                    </h3>
                    <p className="text-white/70 text-sm leading-relaxed font-light line-clamp-2">
                      {project.description}
                    </p>
                    ...
                    <div className="flex flex-wrap gap-1">
                      {project.tech.slice(0, 3).map((tech) => (
                        <span 
                          key={tech}
                          className="px-2 py-1 bg-zinc-900/50 text-white/60 text-xs rounded"
                        >
                          {tech}
                        </span>
                      ))}
