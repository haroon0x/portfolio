      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <div className="grid lg:grid-cols-2 gap-12 sm:gap-16 lg:gap-20 items-center">
            {/* Content */}
            <div className="space-y-8 sm:space-y-10 transform-3d">
            ...
            {/* Enhanced Visual */}
            <div className="relative transform-3d order-first lg:order-last">
              <div className="aspect-square bg-gradient-to-br from-zinc-900 to-black rounded-2xl sm:rounded-3xl border border-white/10 overflow-hidden relative group card-3d">
                {/* 3D Layered Elements */}
                ...
                <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 preserve-3d">
                  <div className="w-16 sm:w-20 lg:w-24 h-16 sm:h-20 lg:h-24 bg-gradient-to-br from-blue-400/20 to-cyan-500/20 rounded-xl sm:rounded-2xl rotate-45 group-hover:rotate-90 transition-all duration-700 transform-gpu hover-3d" />
                </div>

                {/* Subtle Depth Indicators */}
                <div className="absolute top-3 sm:top-4 right-3 sm:right-4 w-1.5 sm:w-2 h-1.5 sm:h-2 bg-blue-400/30 rounded-full animate-pulse-3d" />
                <div className="absolute bottom-3 sm:bottom-4 left-3 sm:left-4 w-1 sm:w-1 h-1 sm:h-1 bg-cyan-400/40 rounded-full animate-pulse-3d" style={{ animationDelay: '1s' }} />
              </div>
            </div>
          </div>
        </div>
